 ...
 *     connected to the domain or are at a serverless domain.
 *     <em>Read-only.</em>
 ...
 *     <code>localhost</code>, or an IP address). Is blank if you're at a serverless domain.
 *     <em>Read-only.</em>
 * @property {string} href - Your current metaverse address (e.g., <code>"hifi://avatarisland/15,-10,26/0,0,0,1"</code>)
 *     regardless of whether or not you're connected to the domain. Starts with <code>"file:///"</code> if at a serverless 
 *     domain.
 *     <em>Read-only.</em>

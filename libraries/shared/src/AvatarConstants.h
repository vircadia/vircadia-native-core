...
const float DEFAULT_AVATAR_LATERAL_STEPPING_THRESHOLD = 0.15f;
const float DEFAULT_AVATAR_ANTERIOR_STEPPING_THRESHOLD = 0.07f;
const float DEFAULT_AVATAR_POSTERIOR_STEPPING_THRESHOLD = 0.08f;
const float DEFAULT_AVATAR_HEAD_ANGULAR_VELOCITY_STEPPING_THRESHOLD = 0.6f;

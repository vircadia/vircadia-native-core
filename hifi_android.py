...
ANDROID_PACKAGE_URL = 'https://eu-central-1.linodeobjects.com/vircadia-public/dependencies/android/'
...
ANDROID_PACKAGES = {
    ...
    'hifiAC': {
        'baseUrl': 'https://eu-central-1.linodeobjects.com/vircadia-public/dependencies/',

...

{
    ...
    connect(this, &Application::activeDisplayPluginChanged, reinterpret_cast<scripting::Audio*>(audioScriptingInterface.data()),
...
void Application::registerScriptEngineWithApplicationServices(ScriptEnginePointer scriptEngine) {
    ...
    scriptEngine->registerGlobalObject("LimitlessSpeechRecognition",
                                       DependencyManager::get<LimitlessVoiceRecognitionScriptingInterface>().data());

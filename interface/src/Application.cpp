...
void Application::addAssetToWorld(QString path, QString zipFile, bool isZip, bool isBlocks) {
    ...
    addAssetToWorldWithNewMapping(path, mapping, 0, isBlocks);
}

void Application::addAssetToWorldWithNewMapping(QString filePath, QString mapping, int copy, bool isBlocks) {
    ...
    QObject::connect(request, &GetMappingRequest::finished, this, [=](GetMappingRequest* request) mutable {
        ...
        if (result == GetMappingRequest::NotFound) {
            addAssetToWorldUpload(filePath, mapping, isBlocks);
            ...
            addAssetToWorldWithNewMapping(filePath, mapping, copy, isBlocks);
        } else {
...
void Application::addAssetToWorldUpload(QString filePath, QString mapping, bool isBlocks) {
    ...
    QObject::connect(upload, &AssetUpload::finished, this, [=](AssetUpload* upload, const QString& hash) mutable {
        if (upload->getError() != AssetUpload::NoError) {
            ...
            addAssetToWorldSetMapping(filePath, mapping, hash, isBlocks);
        }
...
void Application::addAssetToWorldSetMapping(QString filePath, QString mapping, QString hash, bool isBlocks) {
    ...
    connect(request, &SetMappingRequest::finished, this, [=](SetMappingRequest* request) mutable {
        if (request->getError() != SetMappingRequest::NoError) {
            ...
            if (filePath.toLower().endsWith(OBJ_EXTENSION) || filePath.toLower().endsWith(FBX_EXTENSION) || 
                filePath.toLower().endsWith(JPG_EXTENSION) || filePath.toLower().endsWith(PNG_EXTENSION) && (!isBlocks)) {

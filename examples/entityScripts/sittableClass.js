...
Sittable.prototype = {
    ...
    hoverOverEntity : function(entityID, mouseEvent) { 
        print("Sittable.hoverOverEntity()");
        this.updateProperties(entityID); // All callbacks start by updating the properties
        this.showIndicators(true);
    },
    
    hoverLeaveEntity : function(entityID, mouseEvent) { 
        print("Sittable.hoverLeaveEntity()");
        this.updateProperties(entityID); // All callbacks start by updating the properties
        this.showIndicators(false);
    },
    
    clickDownOnEntity : function(entityID, mouseEvent) { 
        print("Sittable.clickDownOnEntity()");
        this.updateProperties(entityID); // All callbacks start by updating the properties
        this.handleClickEvent(mouseEvent);
    },

    clickReleaseOnEntity : function(entityID, mouseEvent) { 
        print("Sittable.clickReleaseOnEntity()");
        this.updateProperties(entityID); // All callbacks start by updating the properties
    }
};
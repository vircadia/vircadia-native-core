...
var hatButton = new ToggleButtonBuddy(buttonPositionX, buttonPositionY, BUTTON_WIDTH, BUTTON_HEIGHT, {
    up: ExternalResource.getUrl(ExternalResource.HF_Public, "/tony/icons/hat-up.svg"),
    down: ExternalResource.getUrl(ExternalResource.HF_Public, "/tony/icons/hat-down.svg")
});
...
var coatButton = new ToggleButtonBuddy(buttonPositionX, buttonPositionY, BUTTON_WIDTH, BUTTON_HEIGHT, {
    up: ExternalResource.getUrl(ExternalResource.HF_Public, "/tony/icons/coat-up.svg"),
    down: ExternalResource.getUrl(ExternalResource.HF_Public, "/tony/icons/coat-down.svg")
});
...
var HAT_ATTACHMENT = {
    modelURL: ExternalResource.getUrl(ExternalResource.HF_Public, "/tony/cowboy-hat.fbx"),
    jointName: "Head",
...
var COAT_ATTACHMENT = {
    modelURL: ExternalResource.getUrl(ExternalResource.HF_Content, "/ozan/dev/clothes/coat/coat_rig.fbx"),
    jointName: "Hips",

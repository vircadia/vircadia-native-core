...
//  ExternalResource.getUrl(ExternalResource.HF_Public, "/models/props/flashlight.fbx")
...
(function() {
    ...
    var ON_SOUND_URL = ExternalResource.getUrl(ExternalResource.HF_Public, '/sounds/Switches%20and%20sliders/flashlight_on.wav');
    var OFF_SOUND_URL = ExternalResource.getUrl(ExternalResource.HF_Public, '/sounds/Switches%20and%20sliders/flashlight_off.wav');

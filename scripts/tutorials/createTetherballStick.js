...
var STICK_MODEL_URL = ExternalResource.getUrl(ExternalResource.HF_Content, "/caitlyn/production/raveStick/newRaveStick2.fbx");
...
var ballID = Entities.addEntity({
    type: "Model",
    modelURL: ExternalResource.getUrl(ExternalResource.HF_Content, "/Examples%20Content/production/marblecollection/Star.fbx"),
...
var lineID = Entities.addEntity({
    ...
    textures: ExternalResource.getUrl(ExternalResource.HF_Public, "/alan/Particles/Particle-Sprite-Smoke-1.png"),
    position: ballStartPosition,
    dimensions: {
        x: 10,
        y: 10,

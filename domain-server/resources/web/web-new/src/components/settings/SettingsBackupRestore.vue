<template>
    <q-card class="my-card q-pa-md">
        ...
        <div style="display: flex; justify-content: center; align-items: center; ">
            ...
            <q-uploader label="Upload a Settings Configuration" max-files="1" url="http://localhost:40100/settings/restore" style="margin: auto; height: 500px; min-width: 100%; background-image: linear-gradient(-45deg, #3d3d3d 25%, #333 25%, #333 50%, #3d3d3d 50%, #3d3d3d 75%, #333 75%, #333 100%); background-size: 100px 100px; border: dashed 1px lightgrey;"/>
        </div>
    </q-card>
    <div class="q-mt-md">

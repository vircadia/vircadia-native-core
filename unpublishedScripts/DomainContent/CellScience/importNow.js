...
var cellLayout;
var baseLocation = "https://hifi-production.s3.amazonaws.com/DomainContent/CellScience/";
...
function CreateNavigationButton(scene, name) {
    ...
    var scriptURL = baseLocation + "Scripts/nav_button_" + name + ".js?" + version;

    navProps.script = scriptURL;
    var nav = Entities.addEntity(navProps);
...
Script.setTimeout(function() {
    CreateNavigationButton(scenes[0], 'cells');
    CreateNavigationButton(scenes[1], 'inside_the_cell');
    CreateNavigationButton(scenes[2], 'ribosome');
    CreateNavigationButton(scenes[3], 'hexokinase');

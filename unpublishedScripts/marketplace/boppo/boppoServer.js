    ...
    var createBoppoServer = function() {
        ...
        var BoppoServer = function () {
            ...
            CLOWN_LAUGHS.forEach(function(clownLaugh) {
                _clownLaughs.push(SoundCache.getSound(ExternalResource.getUrl(ExternalResource.HF_Content, + clownLaugh)));
            });
            _tickTockSound = SoundCache.getSound(ExternalResource.getUrl(ExternalResource.HF_Content, TICK_TOCK_SOUND));
            _boxingBellRingStart = SoundCache.getSound(ExternalResource.getUrl(ExternalResource.HF_Content, BOXING_RING_BELL_START));
            _boxingBellRingEnd = SoundCache.getSound(ExternalResource.getUrl(ExternalResource.HF_Content, BOXING_RING_BELL_END));
            _music = SoundCache.getSound(ExternalResource.getUrl(ExternalResource.HF_Content, BOPPO_MUSIC));
            _boppoEntities = {};
        };
        ...
        BoppoServer.prototype = {
            ...
            resetBoppo: function() {
                ...
                _boppoClownID = Entities.addEntity({
                    angularDamping: 0.0,
                    collisionSoundURL: ExternalResource.getUrl(ExternalResource.HF_Content, 'caitlyn/production/elBoppo/51460__andre-rocha-nascimento__basket-ball-01-bounce.wav'),
                    collisionsWillMove: true,
                    compoundShapeURL: ExternalResource.getUrl(ExternalResource.HF_Content, 'caitlyn/production/elBoppo/bopo_phys.obj'),
                    damping: 1.0,
                    density: 10000,
                    dimensions: {
                    ...
                    modelURL: ExternalResource.getUrl(ExternalResource.HF_Content, 'caitlyn/production/elBoppo/elBoppo3_VR.fbx'),

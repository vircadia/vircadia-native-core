...
file(READ "${VCPKG_ROOT_DIR}/_env/EXTERNAL_QUAZIP_URLS.txt" EXTERNAL_QUAZIP_URLS)
file(READ "${VCPKG_ROOT_DIR}/_env/EXTERNAL_QUAZIP_SHA512.txt" EXTERNAL_QUAZIP_SHA512)

vcpkg_download_distfile(
    SOURCE_ARCHIVE
    URLS ${EXTERNAL_QUAZIP_URLS}
    SHA512 ${EXTERNAL_QUAZIP_SHA512}
    FILENAME quazip.zip
)

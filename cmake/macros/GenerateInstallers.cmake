...
macro(GENERATE_INSTALLERS)
  ...
  elseif (SERVER_ONLY)
    set(_PACKAGE_NAME_EXTRA "-Console")
    set(INSTALLER_TYPE "server_only")
    string(REGEX REPLACE "High Fidelity" "High Fidelity Console" _DISPLAY_NAME ${BUILD_ORGANIZATION})
  else ()
  ...
  if (BUILD_SERVER)
    cpack_add_component(${SERVER_COMPONENT} DISPLAY_NAME "High Fidelity Console")
  endif ()

...
macro(GENERATE_INSTALLERS)
  ...
  elseif (APPLE)
    ...
    message(STATUS "####### GenerateInstallers.cmake")

    message(STATUS "####... CMAKE_INSTALL_PREFIX: ${CMAKE_INSTALL_PREFIX}")

    set(CPACK_GENERATOR "DragNDrop")

    set(CPACK_PACKAGE_INSTALL_DIRECTORY "../Vircadia.app/")
    set(CPACK_PACKAGING_INSTALL_PREFIX "../Vircadia.app/")
    set(CPACK_OSX_PACKAGE_VERSION ${CMAKE_OSX_DEPLOYMENT_TARGET})

    message(STATUS "####... CPACK_INSTALL_PREFIX: ${CPACK_INSTALL_PREFIX}")
    message(STATUS "####... CPACK_PACKAGING_PREFIX: ${CPACK_PACKAGING_PREFIX}")
    ...
    message(STATUS "####... DMG_SUBFOLDER_NAME: ${DMG_SUBFOLDER_NAME}")
    message(STATUS "####... ESCAPED_DMG_SUBFOLDER_NAME: ${ESCAPED_DMG_SUBFOLDER_NAME}")

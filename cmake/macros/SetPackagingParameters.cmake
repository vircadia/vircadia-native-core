...
macro(SET_PACKAGING_PARAMETERS)
  ...
  if (APPLE)
    ...
    set(UTILS_APP_CONTENTS "${INTERFACE_INSTALL_APP_PATH}/Contents")
    set(UTILS_COMPONENT_APP_PATH "${UTILS_APP_CONTENTS}/MacOS/Utils.app")
    set(UTILS_COMPONENT_INSTALL_DIR "${UTILS_COMPONENT_APP_PATH}/Contents/MacOS")
    set(UTILS_PLUGIN_INSTALL_DIR "${UTILS_COMPONENT_APP_PATH}/Contents/PlugIns")

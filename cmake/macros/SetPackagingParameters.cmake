...
macro(SET_PACKAGING_PARAMETERS)
  ...
  if (WIN32)
    ...
    if (PRODUCTION_BUILD)
      ...
      set(SANDBOX_SHORTCUT_NAME "High Fidelity Sandbox")
      set(APP_USER_MODEL_ID "com.highfidelity.console")
    else ()
      ...
      set(SANDBOX_SHORTCUT_NAME "High Fidelity Sandbox - ${BUILD_VERSION_NO_SHA}")
    endif ()

    set(INTERFACE_HF_SHORTCUT_NAME "${INTERFACE_SHORTCUT_NAME}")
    set(CONSOLE_HF_SHORTCUT_NAME "${CONSOLE_SHORTCUT_NAME}")
    set(SANDBOX_HF_SHORTCUT_NAME "${SANDBOX_SHORTCUT_NAME}")

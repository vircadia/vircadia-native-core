...
macro(SETUP_HIFI_CLIENT_SERVER_PLUGIN)
  ...
  if (CMAKE_SYSTEM_NAME MATCHES "Linux" OR CMAKE_GENERATOR STREQUAL "Unix Makefiles")
    set(CLIENT_PLUGIN_FULL_PATH "${CMAKE_BINARY_DIR}/${INTERFACE_BUNDLE_NAME}/${CLIENT_PLUGIN_PATH}/")
    set(SERVER_PLUGIN_FULL_PATH "${CMAKE_BINARY_DIR}/assignment-client/${SERVER_PLUGIN_PATH}/")
  elseif (APPLE)
    set(CLIENT_PLUGIN_FULL_PATH "${CMAKE_BINARY_DIR}/${INTERFACE_BUNDLE_NAME}/$<CONFIGURATION>/${CLIENT_PLUGIN_PATH}/")
